...
public class MyJzvdStd extends Jzvd {
    ...
    public int getLayoutId() {
        return R.layout.layout_video_full;
    }
    ...
    public void showWifiDialog() {
        ...
        new MaterialStyledDialog.Builder(getContext())
                ...
                .setNegativeText(getResources().getString(cn.jzvd.R.string.tips_not_wifi_cancel))
    ...
    public void setBatteryLevel() {
        ...
        if (percent < 20) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_20);
        } else if (percent >= 20 && percent < 40) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_30);
        } else if (percent >= 40 && percent < 60) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_50);
        } else if (percent >= 60 && percent < 70) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_60);
        } else if (percent >= 70 && percent < 85) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_80);
        } else if (percent >= 85 && percent < 95) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_90);
        } else if (percent >= 95 && percent <= 100) {
            batteryLevel.setBackgroundResource(R.drawable.ic_battery_full);
        }
    }
